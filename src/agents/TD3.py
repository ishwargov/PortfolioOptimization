...
sys.path.insert(
    0, '/home/ishwar/Desktop/work/portopt/PortfolioOptimization/src/envs')
...
def parse_args():
    ...
    parser.add_argument("--window-size", type=int, default=7,
        help="window size for observation space")
...
if __name__ == "__main__":
    args = parse_args()
    run_name = f"PortfolioEnv__{args.exp_name}__{args.seed}__{int(time.time())}"
    if args.track:
        import wandb
    ...
    envs = gym.vector.SyncVectorEnv(
        [make_env(args.window_size, x_train)])
